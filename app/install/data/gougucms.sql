...
INSERT INTO `cms_admin_rule` VALUES (6, 0, '', '单 页 面', '单页面管理', 'bi-stickies', 1, 6, 1, 0, 0);
...
INSERT INTO `cms_admin_rule` VALUES (20, 1, 'admin/admin/index', '管 理 员', '管理员', '', 1, 1, 1, 0, 0);
...
INSERT INTO `cms_admin_rule` VALUES (25, 1, 'admin/database/database', '备份数据', '数据备份', '', 1, 1, 1, 0, 0);
INSERT INTO `cms_admin_rule` VALUES (26, 25, 'admin/database/backup', '备份数据表', '数据', '', 2, 1, 1, 0, 0);
INSERT INTO `cms_admin_rule` VALUES (27, 25, 'admin/database/optimize', '优化数据表', '数据表', '', 2, 1, 1, 0, 0);
INSERT INTO `cms_admin_rule` VALUES (28, 25, 'admin/database/repair', '修复数据表', '数据表', '', 2, 1, 1, 0, 0);

INSERT INTO `cms_admin_rule` VALUES (29, 1, 'admin/database/backuplist', '还原数据', '数据还原', '', 1, 1, 1, 0, 0);
INSERT INTO `cms_admin_rule` VALUES (30, 29, 'admin/database/import', '还原数据表', '数据', '', 2, 1, 1, 0, 0);
INSERT INTO `cms_admin_rule` VALUES (31, 29, 'admin/database/downfile', '下载备份数据', '备份数据', '', 2, 1, 1, 0, 0);
INSERT INTO `cms_admin_rule` VALUES (32, 29, 'admin/database/del', '删除备份数据', '备份数据', '', 2, 1, 1, 0, 0);
...
INSERT INTO `cms_admin_rule` VALUES (65, 62, 'admin/user/disable', '禁用/启用','用户', '', 2, 1, 1, 0, 0);
...
-- ----------------------------
INSERT INTO `cms_article_cate` VALUES (1, 0, 0, '勾股开源系统', '1', '左手自研，右手开源', 0, 1610196442);
...
-- ----------------------------
INSERT INTO `cms_article` VALUES (1, '勾股CMS——轻量级、高性能极速后台开发框架', '', '勾股CMS是一套基于ThinkPHP6 + Layui + MySql打造的轻量级、高性能极速后台开发框架。通用型的后台权限管理框架，极低门槛、操作简单、开箱即用。系统易于功能扩展，代码维护，方便二次开发，让开发者更专注于业务深度需求的开发，帮助开发者简单高效降低二次开发成本。', 1, 1, 0, '', '', '<p>勾股CMS是一套基于ThinkPHP6 + Layui + MySql打造的轻量级、高性能极速后台开发框架。通用型的后台权限管理框架，极低门槛、操作简单、开箱即用。系统易于功能扩展，代码维护，方便二次开发，让开发者更专注于业务深度需求的开发，帮助开发者简单高效降低二次开发成本。</p>\n<p><img src=\"https://blog.gougucms.com/storage/image/202109/1630457997502502.png\" /></p>', '勾股CMS是一套基于ThinkPHP6 + Layui + MySql打造的轻量级、高性能极速后台开发框架。通用型的后台权限管理框架，极低门槛、操作简单、开箱即用。系统易于功能扩展，代码维护，方便二次开发，让开发者更专注于业务深度需求的开发，帮助开发者简单高效降低二次开发成本。', 0, 2, 1, 0, 1, 1625071256, 1650811576, 0);
INSERT INTO `cms_article` VALUES (2, '勾股BLOG——简约，易用开源的个人博客系统', '', '勾股BLOG是一款实用的开源免费的个人博客系统。集成了系统管理、基础数据、博客文章、博客动态、语雀知识库、用户管理、访问统计等功能。具有简约，易用，内存占用低等特点，可以用来做个人博客，工作室官网，自...', 1, 2, 0, '', '', '<p>勾股BLOG是一款实用的开源免费的个人博客系统。集成了系统管理、基础数据、博客文章、博客动态、语雀知识库、用户管理、访问统计等功能。具有简约，易用，内存占用低等特点，可以用来做个人博客，工作室官网，自媒体官网等网站，二次开发之后也可以作为资讯、展品展示等网站。</p>\n<p><img src=\"https://blog.gougucms.com/storage/image/b1.png\" /></p>', '勾股BLOG是一款实用的开源免费的个人博客系统。集成了系统管理、基础数据、博客文章、博客动态、语雀知识库、用户管理、访问统计等功能。具有简约，易用，内存占用低等特点，可以用来做个人博客，工作室官网，自媒体官网等网站，二次开发之后也可以作为资讯、展品展示等网站。', 0, 0, 1, 0, 1, 1650811439, 1650811624, 0);
INSERT INTO `cms_article` VALUES (3, '勾股OA——实用的开源的企业办公系统框架', '', '勾股OA是一款实用的开源免费的企业办公系统框架。它集成了系统设置、人事管理、消息管理、审批管理、日常办公、财务管理等基础模块。系统简约，易于功能扩展，方便二次开发，让开发者更专注于业务深度需求的开发，...', 1, 3, 0, '', '', '<p>勾股OA是一款实用的开源免费的企业办公系统框架。它集成了系统设置、人事管理、消息管理、审批管理、日常办公、财务管理等基础模块。系统简约，易于功能扩展，方便二次开发，让开发者更专注于业务深度需求的开发，通过二次开发之后可以用来做CRM，ERP，业务管理等系统。</p>\n<p><img src=\"https://oa.gougucms.com/storage/image/oa1.png\" /></p>', '勾股OA是一款实用的开源免费的企业办公系统框架。它集成了系统设置、人事管理、消息管理、审批管理、日常办公、财务管理等基础模块。系统简约，易于功能扩展，方便二次开发，让开发者更专注于业务深度需求的开发，通过二次开发之后可以用来做CRM，ERP，业务管理等系统。', 0, 0, 1, 0, 1, 1650811502, 1650811709, 0);
INSERT INTO `cms_article` VALUES (4, '勾股DEV——研发管理与团队协作的工具软件', '', '勾股DEV是一款专为IT行业研发团队打造的智能化项目管理与团队协作的工具软件，可以在线管理团队的工作、项目和任务，覆盖从需求提出到研发完成上线整个过程的项目协作。', 1, 4, 0, '', '', '<p>勾股DEV是一款专为IT行业研发团队打造的智能化项目管理与团队协作的工具软件，可以在线管理团队的工作、项目和任务，覆盖从需求提出到研发完成上线整个过程的项目协作。</p>\n<p><img src=\"https://dev.gougucms.com/storage/202204/dev2.png\" /></p>', '勾股DEV是一款专为IT行业研发团队打造的智能化项目管理与团队协作的工具软件，可以在线管理团队的工作、项目和任务，覆盖从需求提出到研发完成上线整个过程的项目协作。', 0, 0, 1, 0, 1, 1650811542, 1650811682, 0);
...
-- ----------------------------
INSERT INTO `cms_goods` VALUES (1, 1, 1, 1, 1, '勾股CMS，勾股Blog，勾股OA定制开发方案', 1, '', '赠送一年免费维护服务', '','勾股CMS定制开发方案99元起，勾股Blog定制开发方案199元起，勾股OA定制开发方案299元起。欢迎联系QQ:327725426咨询定制 。</p>', '勾股CMS定制开发方案99元起，勾股Blog定制开发方案199元起，勾股OA定制开发方案299元起。欢迎联系QQ:327725426咨询定制。', 199.00, 99.00, 0, 0, '', 0, 0, 0, 1, 1, '1,2,6', 0, 1644823517, 0);
...
-- ----------------------------
INSERT INTO `cms_pages` VALUES (1, 1, '关于我们', 1, '', '勾股CMS是一套基于ThinkPHP6+Layui+MySql打造的轻量级、高性能快速建站的内容管理系统。后台管理模块，一目了然，操作简单，通用型后台权限管理框架，开箱即用。', '<p>勾股CMS是一套基于ThinkPHP6 + Layui + MySql打造的轻量级、高性能极速后台开发框架。通用型的后台权限管理框架，操作简单、开箱即用。系统易于功能扩展，代码维护，方便二次开发，让开发者更专注于业务深度需求的开发，帮助开发者简单高效降低二次开发成本。</p>\n<p><img src=\"https://blog.gougucms.com/storage/image/202109/1630457997502502.png\" /></p>', '', 1, 0, '', 'default', 0, 1653984295, 1653993466);
INSERT INTO `cms_pages` VALUES (2, 1, '勾股OA办公系统', 0, '', '勾股OA是一款实用的企业办公系统框架。集成了系统设置、人事管理、消息管理、审批管理、日常办公、财务管理等基础模块。系统简约，易于功能扩展，方便二次开发，让开发者更专注于业务深度需求的开发，通过二次开发之后可以用来做CRM，ERP，业务管理等系统。', '<p>勾股OA是一款实用的企业办公系统框架。集成了系统设置、人事管理、消息管理、审批管理、日常办公、财务管理等基础模块。系统简约，易于功能扩展，方便二次开发，让开发者更专注于业务深度需求的开发，通过二次开发之后可以用来做CRM，ERP，业务管理等系统。</p>', '', 9, 0, 'gouguoa', 'oa', 0, 1654419120, 0);
INSERT INTO `cms_pages` VALUES (3, 1, '勾股DEV项目管理系统', 0, '', '勾股DEV是一款专为IT研发团队打造的项目管理与团队协作的系统工具，可以在线管理团队的工作、项目和任务，覆盖从需求提出到研发完成上线整个过程的项目协作。', '<p >勾股DEV是一款专为IT研发团队打造的项目管理与团队协作的系统工具，可以在线管理团队的工作、项目和任务，覆盖从需求提出到研发完成上线整个过程的项目协作。</p>\n<p>勾股DEV的产品理念：通过&ldquo;项目（Project）&rdquo;的形式把成员、需求、任务、缺陷(BUG)、文档、互动讨论以及各种形式的资源组织在一起，团队成员参与更新任务、文档等内容来推动项目的进度，同时系统利用时间线索和各种动态的报表的形式来自动给成员汇报项目进度。</p>', '', 8, 0, 'gougudev', 'dev', 0, 1654167139, 0);
